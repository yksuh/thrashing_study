		...
		<HTML>
			...
			<xsl:for-each select="testResult">
				...
				<xsl:for-each select="queryResult">
					...
					<thead>
					<th>Table Name</th>
					<th>Cardinality of Query Execution</th>
					...
					<th>Iteration Number</th>
						...
						<tr align="right">
							...
							<td><xsl:value-of select="optimalPlan/@phaseNumber"/></td>
							<td><xsl:value-of select="optimalPlan/@executionTime"/><xsl:if test="optimalPlan/@units = 'milli seconds'"> ms</xsl:if></td>
							<td><xsl:value-of select="optimalPlan/@psdiff"/></td>
							<td><xsl:value-of select="optimalPlan/@iternum"/></td>
						</tr>
					</table>
					<BR/>
			...
			<HR/>
				...
				<BR/>
				  ...
				  <xsl:for-each select="queryResult">
					...
					<thead>
					<th>Table Name</th>
					<th>Cardinality of Query Run</th>
					<th>Query Plan Number</th>
					<th>Phase</th>
					<th>Execution Time of Plan</th>
					<th>PS Diff</th>
	...
	<xsl:template match="/result">
		<HTML>
			...
			<HR/>
					...
					The values in the table below show how the DBMS performed with different
					cardinality statistics.
					<table cellpadding="5" border="1" >
					<thead>
					<th>Table Name</th>
