...
public class SubOptimalScenario extends VaryCardinalityScenario {
	public SubOptimalScenario(ExperimentRun expRun) {
		super(expRun);
	}
	...
	protected void setName() {
		scenarioName = Constants.NAME_SUB_OPTIMAL_SCENARIO;
	}

	@Override
	protected void setVersion() {
		versionName = Constants.VERSION_SUB_OPTIMAL_SCENARIO;
	}
