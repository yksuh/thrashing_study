...
CREATE TABLE AZDBLAB_BATCHSETHASPARAMETER(
	...
	AvgLockWaitTime NUMBER(10), -- avg of lock wait time for all batches in this set
	MaxMPL 		NUMBER(10),
...
CREATE TABLE AZDBLAB_BATCHHASRESULT(
	...
	SumLockWaitTime Number(10), -- sum of lockwaittime of each client
	FOREIGN KEY (BATCHID) REFERENCES AZDBLAB_BATCH(BATCHID) ON DELETE CASCADE,
...
CREATE TABLE AZDBLAB_CLIENTHASRESULT(
	...
	LockWaitTime Number(10), -- sum of (elapsed time - min(elaped time))
