 ...
 * 
 */
public class ProtocolPluginNode extends ObjectNode {

	private String strDateCreate;

	public ProtocolPluginNode() {
		strNodeName = "Protocol Plugins";
	}
	...
	private JPanel createAspectPanel() {
		...
		info += "All the Protocol Plugins";
		info += "</font></BODY></HTML>";

		NodePanel npl_toRet = new NodePanel();
		npl_toRet.addComponentToTab("Protocol Plugin Info", createTextPaneFromString(info));
