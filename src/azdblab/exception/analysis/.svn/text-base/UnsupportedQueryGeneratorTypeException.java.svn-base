...
/**
 * Thrown if the specified query generator is not supported.
 * @author Kevan Holdaway
 *
 */
public class UnsupportedQueryGeneratorTypeException extends Exception {
	private static final long serialVersionUID =  System
	.identityHashCode("UnsupportedQueryGeneratorTypeException");
	/**
	 * Creates a DBMS an exception of this type.
	 */
	public UnsupportedQueryGeneratorTypeException() {
		super();
	}
	 ...
	 */
	public UnsupportedQueryGeneratorTypeException(String message) {
		super(message);
	}
	 ...
	 */
	public UnsupportedQueryGeneratorTypeException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public UnsupportedQueryGeneratorTypeException(Throwable cause) {
		super(cause);
	}
}
