...
lavaan (0.5-17) converged normally after  22 iterations
  ...
  Estimator                                         ML
  Minimum Function Test Statistic                6.391
...
Loglikelihood and Information Criteria:
  ...
  Loglikelihood user model (H0)              -2767.264
  Loglikelihood unrestricted model (H1)      -2764.068

  Number of free parameters                         11
  Akaike (AIC)                                5556.527
  Bayesian (BIC)                              5610.556
  Sample-size adjusted Bayesian (BIC)         5575.620

Root Mean Square Error of Approximation:

  RMSEA                                          0.047
  90 Percent Confidence Interval          0.008  0.090
...
Regressions:
  ATP ~
    NUMPROCE (a1)    -0.079    0.020   -3.891    0.000   -0.079   -0.118
    PK       (a3)    -0.104    0.016   -6.509    0.000   -0.104   -0.198
    PCTUPDAT (a4)    -0.101    0.021   -4.747    0.000   -0.101   -0.144
  MAXMPL ~
    ATP      (b1)    -0.066    0.047   -1.397    0.162   -0.066   -0.045
    NUMPROCE (c1)    -0.032    0.031   -1.045    0.296   -0.032   -0.033
    ACTROWPO (c2)    -0.059    0.032   -1.855    0.064   -0.059   -0.057
    PK       (c3)     0.119    0.024    4.887    0.000    0.119    0.155
    PCTUPDAT (c4)    -0.015    0.036   -0.430    0.667   -0.015   -0.015
    PCTREAD  (c5)    -0.069    0.041   -1.690    0.091   -0.069   -0.058

Variances:
    ATP               0.064    0.003                      0.064    0.924
    MAXMPL            0.143    0.006                      0.143    0.964

Defined parameters:
    INT_1             0.010    0.003    3.861    0.000    0.010    0.028
