...
/**
 * Thrown if the Analyzer type is not supported.
 * @author Kevan Holdaway
 *
 */
public class UnsupportedAnalyzerType extends Exception {
	private static final long serialVersionUID =  System
	.identityHashCode("UnsupportedAnalyzerType");
	/**
	 * Creates a DBMS an exception of this type.
	 */
	public UnsupportedAnalyzerType() {
		super();
	}
	 ...
	 */
	public UnsupportedAnalyzerType(String message) {
		super(message);
	}
	 ...
	 */
	public UnsupportedAnalyzerType(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public UnsupportedAnalyzerType(Throwable cause) {
		super(cause);
	}
}
