...
public class SetActualScenario extends VaryCardinalityScenario {
  public SetActualScenario(ExperimentRun expRun) {
    super(expRun);
  }
...
protected void setName() {
	scenarioName = Constants.NAME_SET_ACTUAL_SCENARIO;
}

@Override
protected void setVersion() {
	versionName = Constants.VERSION_SET_ACTUAL_SCENARIO;
}
