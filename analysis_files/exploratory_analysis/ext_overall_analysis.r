...
summary(med.fit)
	...
	-0.3741 -0.1620 -0.1018  0.2240  0.8697 

	Coefficients:
		      Estimate Std. Error t value Pr(>|t|)    
	(Intercept)    0.38501    0.02809  13.708  < 2e-16 ***
	NUMPROCESSORS -0.08569    0.04166  -2.057   0.0404 *  
	PK            -0.21186    0.02940  -7.206 2.96e-12 ***
	---
	Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

	Residual standard error: 0.2919 on 393 degrees of freedom
	Multiple R-squared:  0.1279,	Adjusted R-squared:  0.1234 
	F-statistic: 28.81 on 2 and 393 DF,  p-value: 2.113e-12
		...
		Residuals:
		    Min      1Q  Median      3Q     Max 
		-0.4189 -0.1785 -0.1029  0.2118  0.8360 

		Coefficients:
				          Estimate Std. Error t value Pr(>|t|)    
		(Intercept)               0.353382   0.064320   5.494 7.11e-08 ***
		PK                       -0.225837   0.037668  -5.995 4.64e-09 ***
		PCTREAD                  -0.051197   0.046381  -1.104    0.270    
		ACTROWPOOL                0.076225   0.089303   0.854    0.394    
		NUMPROCESSORS            -0.087884   0.101712  -0.864    0.388    
		PK:PCTREAD                0.041599   0.066901   0.622    0.534    
		ACTROWPOOL:NUMPROCESSORS  0.008507   0.149585   0.057    0.955    
		---
		Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

		Residual standard error: 0.2921 on 389 degrees of freedom
		Multiple R-squared:  0.1357,	Adjusted R-squared:  0.1223 
		F-statistic: 10.18 on 6 and 389 DF,  p-value: 1.823e-10
...
#main = "Sensitiviy Analysis with Respect to \n Error Correlation between the Mediator (ATP time) and Outcome Models (Thrashing Point)", 
	...
	F-statistic: 6.151 on 3 and 184 DF,  p-value: 0.0005236
		...
		Residuals:
		     Min       1Q   Median       3Q      Max 
		-0.62060 -0.26963 -0.02234  0.23930  0.73077 

		Coefficients:
			       Estimate Std. Error t value Pr(>|t|)    
		(Intercept)    0.428774   0.083208   5.153 6.63e-07 ***
		PK             0.232287   0.056915   4.081 6.70e-05 ***
		PCTREAD        0.018070   0.054323   0.333   0.7398    
		ACTROWPOOL    -0.172120   0.087134  -1.975   0.0497 *  
		ATP            0.015677   0.075369   0.208   0.8355    
		NUMPROCESSORS  0.009455   0.075571   0.125   0.9006    
		---
		Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

		Residual standard error: 0.3277 on 182 degrees of freedom
		Multiple R-squared:  0.1106,	Adjusted R-squared:  0.08612 
