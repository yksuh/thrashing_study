...
summary(med.fit)
	...
	-0.51848 -0.09990 -0.02235  0.06945  0.56597 

	Coefficients:
		      Estimate Std. Error t value Pr(>|t|)    
	(Intercept)    0.49729    0.07306   6.807 4.98e-09 ***
	NUMPROCESSORS -0.30164    0.05952  -5.068 4.00e-06 ***
	PK             0.09456    0.08223   1.150    0.255    
	PCTUPDATE      0.02861    0.09277   0.308    0.759    
	PK:PCTUPDATE  -0.05715    0.12242  -0.467    0.642    
	---
	Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

	Residual standard error: 0.1829 on 61 degrees of freedom
	Multiple R-squared:  0.3442,	Adjusted R-squared:  0.3012 
	F-statistic: 8.004 on 4 and 61 DF,  p-value: 2.964e-05
...
lm(formula = MAXMPL ~ PK + PCTUPDATE + ACTROWPOOL + ATP + NUMPROCESSORS, 
	...
	Residuals:
	     Min       1Q   Median       3Q      Max 
	-0.42166 -0.06973  0.00371  0.05658  0.36616 

	Coefficients:
		      Estimate Std. Error t value Pr(>|t|)    
	(Intercept)    0.66269    0.08154   8.127 2.97e-11 ***
	PK            -0.05493    0.03887  -1.413 0.162779    
	PCTUPDATE     -0.05196    0.05016  -1.036 0.304463    
	ACTROWPOOL     0.05937    0.05089   1.167 0.248027    
	ATP           -0.39196    0.10615  -3.692 0.000482 ***
	NUMPROCESSORS -0.53686    0.05864  -9.155 5.43e-13 ***
	---
	Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

	Residual standard error: 0.1513 on 60 degrees of freedom
	Multiple R-squared:  0.596,	Adjusted R-squared:  0.5624 
	F-statistic: 17.71 on 5 and 60 DF,  p-value: 9.682e-11
...
summary(out.fit)
	...
	Deviance Residuals: 
	     Min        1Q    Median        3Q       Max  
	-1.88563  -0.30695   0.00646   0.19198   2.54308  

	Coefficients:
		      Estimate Std. Error z value Pr(>|z|)    
	(Intercept)    -2.8087     0.5962  -4.711 2.47e-06 ***
	PK             -0.5963     0.4416  -1.350   0.1769    
	PCTUPDATE       1.0666     0.5208   2.048   0.0405 *  
	ACTROWPOOL     -0.2396     0.4731  -0.507   0.6125    
	ATP             5.2180     1.0597   4.924 8.48e-07 ***
	NUMPROCESSORS   4.5618     0.8801   5.183 2.18e-07 ***
	---
	Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

	(Dispersion parameter for binomial family taken to be 1)

	    Null deviance: 171.384  on 123  degrees of freedom
	Residual deviance:  63.721  on 118  degrees of freedom
	AIC: 75.721
...
lm.beta(out.fit)
   ...
   -0.5974534     0.7964977    -0.1789665     2.3117740     3.4483717
