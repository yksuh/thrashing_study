...
/**
 * This experiment scenario tests plan non-monotonicity by exhaustively looping
...
public class ExhaustiveScenario extends ScenarioBasedOnCardinality {
	/**
	 * @param expRun
	 *            experiment run instance
	 */
	public ExhaustiveScenario(ExperimentRun expRun) {
		super(expRun);
