...
CREATE TABLE __Chosen_Notebooks_Ver1__ AS
	...
	WHERE notebookName LIKE 'PVLDB13';
...
CREATE TABLE __Analysis_S0_AQE_Ver1__ AS
	...
	FROM  AZDBLab_Experiment ex, 
	      ...
	      __Chosen_Users_Ver1__ c_user,
              __Chosen_Notebooks_Ver1__ c_notebook,
...
INSERT INTO __Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       ...
	       '__Analysis_S0_AQE_Ver1__' as stepName,
...
INSERT INTO RM___Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       experimentname as exprName,
	       'RM___Analysis_S1_VQE_Ver1__' as stepName,
	       COUNT(*) as stepResultSize
	FROM RM___Analysis_S1_VQE_Ver1__
	GROUP BY dbms, experimentname;
...
INSERT INTO __Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       experimentname as exprName,
	       '__Analysis_AQED_Ver1__' as stepName,
	       COUNT(*) as stepResultSize
...
INSERT INTO __Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       experimentname as exprName,
	       '__Analysis_ACTQatC_Ver1__' as stepName,
	       COUNT(*) as stepResultSize
