...
#y <- subset(x, x$MAXMPL==1100)
#x <- subset(x, x$MAXMPL<1100)
#z <- subset(x, x$MAXMPL<500)
# ATP normalization
# db2
...
summary(med.fit)
	...
	-0.4222 -0.1679 -0.0764  0.1195  0.8509 

	Coefficients:
		      Estimate Std. Error t value Pr(>|t|)    
	(Intercept)    0.42256    0.02357  17.929  < 2e-16 ***
	NUMPROCESSORS -0.14644    0.03056  -4.791 2.15e-06 ***
	PK            -0.24661    0.03505  -7.036 6.11e-12 ***
	PCTUPDATE     -0.36458    0.04127  -8.835  < 2e-16 ***
	PK:PCTUPDATE   0.39397    0.06369   6.185 1.23e-09 ***
	---
	Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

	Residual standard error: 0.2733 on 533 degrees of freedom
	Multiple R-squared:  0.1944,	Adjusted R-squared:  0.1884 
	F-statistic: 32.15 on 4 and 533 DF,  p-value: < 2.2e-16
...
summary(out.fit)
	...
	Residuals:
	     Min       1Q   Median       3Q      Max 
	-0.61349 -0.31497  0.02906  0.30447  0.70334 

	Coefficients:
		      Estimate Std. Error t value Pr(>|t|)    
	(Intercept)    0.44544    0.04223  10.548  < 2e-16 ***
	ATP            0.06757    0.05356   1.262   0.2076    
	ACTROWPOOL    -0.08000    0.04082  -1.960   0.0505 .  
	NUMPROCESSORS -0.06843    0.03985  -1.717   0.0865 .  
	PCTUPDATE      0.05264    0.04567   1.153   0.2496    
	PCTREAD       -0.05999    0.05025  -1.194   0.2331    
	PK             0.12771    0.03120   4.093 4.92e-05 ***
	---
	Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

	Residual standard error: 0.3491 on 531 degrees of freedom
	Multiple R-squared:  0.05228,	Adjusted R-squared:  0.04157 
	F-statistic: 4.882 on 6 and 531 DF,  p-value: 7.182e-05
