...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<HTML>
		<BODY>
			...
			The query generator will transform simple predicates into complex predicates <xsl:value-of select="where/@complexUsePercentage"/> % of the time.
			</p>
			<p>
	...
	<HTML>
		<BODY>
			...
			<HR/>
			<h3>The predefined queries for this experiment are:</h3>
			<ul>
