...
INSERT INTO __Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       ...
	       'Analysis_S5_I_EQTV_PDE_Ver1' as stepName,
...
INSERT INTO __Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       experimentname as exprName,
	       'Analysis_S5_II_TSM_Ver1' as stepName,
...
INSERT INTO __Analysis_RowCount_Ver1__ (dbmsName, exprName, stepName, stepResultSize)
	SELECT dbms as dbmsName, 
	       experimentname as exprName,
	       'Analysis_S5_II_TRM_Ver1' as stepName,
	       COALESCE(COUNT(*), 0) as stepResultSize
...
SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S2_II_Ver1';

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S2_III_Ver1';

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S2_IV_Ver1';
SELECT COUNT(*) FROM __Analysis_S1_VQE_Ver1__;

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S3_I_Ver1';

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S3_II_Ver1';

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S3_III_Ver1';

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S3_IV_Ver1';
SELECT COUNT(*) FROM __Analysis_ASPQatC_Ver1__;

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S5_II_TSM_Ver1';

SELECT sum(stepResultSize) as stepResultSize 
FROM __Analysis_RowCount_Ver1__ 
WHERE stepName='Analysis_S5_II_TRM_Ver1';
